...
\begin{center}{\textup At Matins}\end{center}
\emph{\openingnote}

\begin{center}{\textup In the \textsc 1st \textup Nocturn}\end{center}
%TODO: 3 psalms
%TODO: versicle and response

Pater noster. \emph{in silence.}

\emph{On these three days, there is neither Absolution nor Blessing.  At the end of the Lessons, \emph{Tu autem} is not said.}

\begin{center}{\textup At Lauds}\end{center}
...
\gregorioscore{\antfivetex\if\antfiveNoEuouae T_noEuouae\fi}
}
...
\fi %vrpttex
{\greblockcustos\gregorioscore{\vrtex}}\vspace{-4pt plus 4pt}
\translation[]{
\Vbar{}~\vtranslation{}%
...
\gregorioscore{MagnificatAntiphon}}%
\fi
}%
\fi%
\fi%
...
%
%
\ifx\benedicamusdominogrefactor\undefined\else\grechangestaffsize{\benedicamusdominogrefactor}\fi

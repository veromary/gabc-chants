...
\grechangestyle{annotation}{\fontsize{10}{11}\selectfont}
% The title:
...
%\sloppy
%,colwidths={1=220pt}
\begin{parcolumns}[sloppy,nofirstindent,rulebetween]{2}
%\sloppy
%	\colchunk{What's up?}
%	\colchunk{Quid altis?}
%	\colplacechunks
\oldprayer{\collect}{\collecttranslation}
\end{parcolumns}
\bigskip
\fi
%
